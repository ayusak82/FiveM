...
Config = {
    ...
    ExchangeRate = 100, --//1 set value of one casino chip, for example, set to 5, if 1 chip equals to 5$ (minimum: 0.1, rounded by 0.1, 0.5 or 1)
    ChipsInventoryItem = "casino_chips",
    UseBankMoney = true, --//false cash or bank?
    ...
    -- Bar
    BarShowSnacks = false, --//true disable, if you want to see only drinks in the bartender menu
    ...
    LUCKY_WHEEL_COOLDOWN = (60 * 60 * 12), -- how long players have to wait for their next spin. def: 24 hours (60 * 60 * 24)
    ...
    LUCKY_WHEEL_CAR_ONE_WINNER = false, --//true set to true, if only one player can win the podium vehicle. the vehicle will disapear from the podium after someone wins it.
    ...
    -- Cashier
    CASHIER_DAILY_BONUS = 3000, --//1000 daily visitor bonus that players can request at the Cashier, set to 0 if you don't want any daily bonuses. def: 1000
    CASHIER_VIP_PRICE = 200000, --//50000 price of the VIP casino membership, def: 50000
    ...
    CASINO_AMBIENT_PEDS_DENSITY = 2, --//3 1: a few, 2: medium, 3: all peds
    ...
    SocietyAutoInstall = false, -- auto install society account if it doesn't exist
    SocietyName = "casino",
    SocietyLimitFromBalance = 10000000, -- if society account has less money than this, it will start paying out reduced money, (SocietyLimitPayoutPercentage)
    ...
    SocietyFramework = Society.RenewedBanking,
    --[[
